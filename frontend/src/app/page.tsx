...
export default function HomePage() { // Renamed from LoginPage to HomePage
    ...
    const LoginForm = () => {
        ...
        return (
            <form id="login-form" onSubmit={handleLogin}>
                ...
                <button type="submit" className="w-full h-12 mt-6 bg-primary text-white font-bold rounded-lg hover:bg-primary/90">登录</button>
                ...
                <div className="relative hidden lg:flex lg:w-3/5 xl:w-2/3 items-center justify-center p-12 left-panel" style={{
                    ...
                    <div className="relative z-10 flex flex-col items-start text-white max-w-2xl">
                        ...
                        <p className="font-display text-xl text-gray-300 leading-relaxed">
                            天眼全域感知系统 - 基于多模态大模型，融合视频内容识别、二次精准识别与ReID技术，实现人车轨迹的智能追踪与分析。
                        </p>
                    </div>
                </div>
